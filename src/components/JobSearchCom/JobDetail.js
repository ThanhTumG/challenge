...
import { Public, Schedule, ChevronLeft, ChevronRight, ArrowRightAlt, WorkOutline } from "@mui/icons-material";
import parse from 'html-react-parser';



export default function JobDetail() {
    const { isDetail, setIsDetail, selectedJob } = useContext(AppContext)
