...
const MenuBars = (props) => {
    ...
    return (
        ...
        <div className="flex flex-col bg-[#FAFBFD] pt-20 pl-[4%] w-[20%] space-y-16 h-screen">
            <div className="flex">
                <h3 className="font-bold text-orange-600">Dev</h3>
                <h3 onClick={() => handleMenu("home")} className="font-bold hover:cursor-pointer">Devchallenges.io</h3>
            </div>
